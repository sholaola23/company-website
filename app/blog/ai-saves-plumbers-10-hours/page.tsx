      ...
      <article className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
              ...
              <table className="w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
                <thead>
                  <tr className="bg-slate-100/60">
                    ...
                    <th className="text-left px-4 py-3 text-slate-600 font-semibold">Hours/Week</th>
                    <th className="text-left px-4 py-3 text-slate-600 font-semibold">Can AI Handle It?</th>
                  </tr>
                </thead>
                <tbody className="text-slate-500">
                  <tr className="border-t border-slate-200">
                    ...
                    <td className="px-4 py-3 text-emerald-600">Yes &mdash; AI voice + chat</td>
                  </tr>
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3">Writing and sending quotes</td>
                    <td className="px-4 py-3">2 hrs</td>
                    <td className="px-4 py-3 text-emerald-600">Yes &mdash; templated + AI-drafted</td>
                  </tr>
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3">Follow-up on quotes</td>
                    <td className="px-4 py-3">1&ndash;2 hrs</td>
                    <td className="px-4 py-3 text-emerald-600">Yes &mdash; automated sequences</td>
                  </tr>
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3">Invoicing and payment chasing</td>
                    <td className="px-4 py-3">1&ndash;2 hrs</td>
                    <td className="px-4 py-3 text-emerald-600">Yes &mdash; auto-invoice + reminders</td>
                  </tr>
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3">Scheduling and calendar management</td>
                    <td className="px-4 py-3">1 hr</td>
                    <td className="px-4 py-3 text-emerald-600">Yes &mdash; AI booking</td>
                  </tr>
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3">Asking for Google reviews</td>
                    <td className="px-4 py-3">30 min</td>
                    <td className="px-4 py-3 text-emerald-600">Yes &mdash; automatic requests</td>
                  </tr>
                  <tr className="border-t border-slate-200 bg-slate-100/30">
                    <td className="px-4 py-3 font-bold text-slate-900">Total</td>
                    <td className="px-4 py-3 font-bold text-slate-900">8&ndash;11 hrs</td>
                    <td className="px-4 py-3 font-bold text-emerald-600">All automatable</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <p className="text-slate-500 leading-relaxed mb-4">
              The Harvard Business Review found that businesses responding to leads within 5 minutes are <strong className="text-slate-900">100 times more likely</strong> to connect than those responding in 30 minutes. For plumbers, where customers often call 2&ndash;3 businesses at once, speed is everything.
            </p>
            ...
            <p className="text-slate-500 leading-relaxed mb-8">
              <strong className="text-slate-900">Time saved:</strong> 2&ndash;3 hours/week. <strong className="text-slate-900">Revenue recovered:</strong> 3&ndash;5 extra jobs per month from leads that would have gone cold.
            </p>
            ...
            <p className="text-slate-500 leading-relaxed mb-8">
              <strong className="text-slate-900">Time saved:</strong> 1&ndash;2 hours/week. <strong className="text-slate-900">Conversion improvement:</strong> Automated follow-ups recover an average of 15&ndash;20% of quotes that would otherwise go cold, according to Jobber&apos;s 2025 industry report.
            </p>
            ...
            <p className="text-slate-500 leading-relaxed mb-8">
              <strong className="text-slate-900">Time saved:</strong> 1 hour/week on phone calls. <strong className="text-slate-900">Revenue impact:</strong> Capture after-hours emergency jobs worth &pound;200&ndash;500 each that currently go to voicemail.
            </p>
