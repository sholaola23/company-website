        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Direct WhatsApp orders</strong>{" "}
                save 15&ndash;30% vs delivery platform commission
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">35% more table bookings</strong>{" "}
                from 24/7 online availability
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">3x more Google reviews</strong>{" "}
                driving new customer discovery
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">5+ hours saved weekly</strong>{" "}
          ...
          <div className="mt-12 border border-zinc-800 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services/order-automation" className="text-zinc-300 hover:text-white transition-colors">
