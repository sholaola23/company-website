          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Direct WhatsApp orders</strong>{" "}
                save 15&ndash;30% vs delivery platform commission
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">35% more table bookings</strong>{" "}
                from 24/7 online availability
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">3x more Google reviews</strong>{" "}
                driving new customer discovery
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">5+ hours saved weekly</strong>{" "}
