        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            <p className="text-slate-500 leading-relaxed mb-4 text-lg">
              <strong className="text-slate-900">AI automation</strong> is the use of artificial intelligence to handle repetitive business tasks &mdash; lead follow-up, appointment booking, email replies, payment reconciliation &mdash; without manual effort. For small businesses, the question is not whether to automate, but how: hire an agency or do it yourself?
            </p>
              ...
              <table className="w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
                <thead>
                  <tr className="bg-slate-100/60">
                    ...
                    <th className="text-left px-4 py-3 text-blue-600 font-semibold">Done-for-You Agency</th>
                    <th className="text-left px-4 py-3 text-amber-600 font-semibold">DIY (Build It Yourself)</th>
                  </tr>
                </thead>
                <tbody className="text-slate-500">
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3 font-medium text-slate-900">Upfront Cost</td>
                  ...
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3 font-medium text-slate-900">Ongoing Cost</td>
            ...
            <ul className="text-slate-500 space-y-2 mb-4 ml-6 list-disc">
              <li><strong className="text-slate-900">You&apos;re losing leads</strong> &mdash; potential customers call, email, or message and don&apos;t hear back for hours (or ever). According to a Harvard Business Review study, responding within 5 minutes makes you 100x more likely to connect with a lead than waiting 30 minutes.</li>
              <li><strong className="text-slate-900">You spend 5+ hours/week on admin</strong> &mdash; data entry, email replies, payment chasing, scheduling. That&apos;s 260 hours per year &mdash; equivalent to 6.5 full working weeks.</li>
              <li><strong className="text-slate-900">You tried DIY and got stuck</strong> &mdash; you have half-built Zapier workflows that don&apos;t quite work, or you gave up after 3 hours of YouTube tutorials.</li>
              <li><strong className="text-slate-900">Your automation needs to connect 4+ systems</strong> &mdash; calendar, CRM, payments, WhatsApp, email, forms. Multi-system workflows are where complexity (and breakage) multiply.</li>
              <li><strong className="text-slate-900">You need reliability</strong> &mdash; if a workflow breaks, someone fixes it the same day. Not next weekend when you have time.</li>
            </ul>
            ...
            <div className="overflow-x-auto mb-8">
              <table className="w-full text-sm border border-slate-200 rounded-xl overflow-hidden">
                <thead>
                  <tr className="bg-slate-100/60">
                    <th className="text-left px-4 py-3 text-slate-600 font-semibold">Cost Element</th>
                    <th className="text-left px-4 py-3 text-blue-600 font-semibold">Agency</th>
                ...
                <tbody className="text-slate-500">
                  ...
                  <tr className="border-t border-slate-200 bg-slate-100/30">
                    <td className="px-4 py-3 font-bold text-slate-900">Total Year 1</td>
                    <td className="px-4 py-3 font-bold text-blue-600">&pound;1,100</td>
                    <td className="px-4 py-3 font-bold text-amber-600">&pound;1,490</td>
                  </tr>
                  <tr className="border-t border-slate-200">
                    <td className="px-4 py-3">Time to live</td>
                    <td className="px-4 py-3 text-emerald-600">5&ndash;7 days</td>
            ...
            <ul className="text-slate-500 space-y-2 mb-4 ml-6 list-disc">
              <li><strong className="text-slate-900">We build it</strong> &mdash; you spend 2&ndash;3 hours briefing us, then we handle everything</li>
              <li><strong className="text-slate-900">We maintain it</strong> &mdash; when APIs change, tools update, or workflows break, we fix it</li>
              <li><strong className="text-slate-900">We optimise it</strong> &mdash; monthly reviews of your KPIs with tweaks to improve performance</li>
              <li><strong className="text-slate-900">We guarantee it</strong> &mdash; 90-day results guarantee: save 5+ hours/week or get your setup fee back</li>
            </ul>
            ...
            <p className="text-slate-500 leading-relaxed mb-4">
              <strong className="text-slate-900">Choose DIY</strong> if you have simple needs, enjoy learning tools, and have 40+ hours to invest before seeing results.
            </p>

            <p className="text-slate-500 leading-relaxed mb-4">
              <strong className="text-slate-900">Choose an agency</strong> if you need results fast, your automation connects multiple systems, and the cost of lost leads or wasted admin time exceeds &pound;500.
            </p>
