        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Problem:</strong> Portal leads
            ...
            <p className="text-zinc-300 leading-relaxed mb-8">
              <strong className="text-zinc-100">Result:</strong> An independent
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Problem:</strong> Booking
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Solution:</strong> A self-serve
            ...
            <p className="text-zinc-300 leading-relaxed mb-8">
              <strong className="text-zinc-100">Result:</strong> Viewing
            ...
            <p className="text-zinc-300 leading-relaxed mb-8">
              <strong className="text-zinc-100">Result:</strong> Agencies using
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Problem:</strong> After a
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Solution:</strong> A multi-touch
            ...
            <p className="text-zinc-300 leading-relaxed mb-8">
              <strong className="text-zinc-100">Result:</strong> Consistent
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Problem:</strong> Reviews are
            ...
            <ul className="text-zinc-300 leading-relaxed mb-4 list-disc pl-6 space-y-2">
              ...
              <li>
                <strong className="text-zinc-100">Scheduling friction</strong>{" "}
                &mdash; fewer viewings than you should be doing
              </li>
              <li>
                <strong className="text-zinc-100">Poor matching</strong>{" "}
                &mdash; sitting on a buyer database you&apos;re not using
              </li>
              <li>
                <strong className="text-zinc-100">Weak follow-up</strong>{" "}
                &mdash; letting warm leads go cold
              </li>
              <li>
                <strong className="text-zinc-100">Low review count</strong>{" "}
