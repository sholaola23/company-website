        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Problem:</strong> Portal leads
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-8">
              <strong className="text-[var(--color-heading)]">Result:</strong> An independent
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Problem:</strong> Booking
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Solution:</strong> A self-serve
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-8">
              <strong className="text-[var(--color-heading)]">Result:</strong> Viewing
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-8">
              <strong className="text-[var(--color-heading)]">Result:</strong> Agencies using
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Problem:</strong> After a
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Solution:</strong> A multi-touch
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-8">
              <strong className="text-[var(--color-heading)]">Result:</strong> Consistent
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Problem:</strong> Reviews are
            ...
            <ul className="text-[var(--color-muted)] leading-relaxed mb-4 list-disc pl-6 space-y-2">
              ...
              <li>
                <strong className="text-[var(--color-heading)]">Scheduling friction</strong>{" "}
                &mdash; fewer viewings than you should be doing
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Poor matching</strong>{" "}
                &mdash; sitting on a buyer database you&apos;re not using
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Weak follow-up</strong>{" "}
                &mdash; letting warm leads go cold
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Low review count</strong>{" "}
