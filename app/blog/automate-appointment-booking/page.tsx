        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              ...
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">No-shows</strong> &mdash;
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Smart qualification</strong> &mdash;
              ...
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">WhatsApp integration</strong> &mdash;
              ...
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Waitlist management</strong> &mdash;
                when you&apos;re fully booked, AI can add people to a waiting
                list and automatically notify them if a slot opens up.
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">No-show prediction</strong> &mdash;
