        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              ...
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">No-shows</strong> &mdash;
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">Smart qualification</strong> &mdash;
              ...
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">WhatsApp integration</strong> &mdash;
              ...
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">Waitlist management</strong> &mdash;
                when you&apos;re fully booked, AI can add people to a waiting
                list and automatically notify them if a slot opens up.
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">No-show prediction</strong> &mdash;
