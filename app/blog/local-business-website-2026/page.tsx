        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">97% of people</strong> search
                online for local services before making a decision
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">75% of consumers</strong> judge
                a business&apos;s credibility based on their website
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">53% of mobile users</strong> abandon
                a site that takes more than 3 seconds to load
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                Businesses with a website get{" "}
                <strong className="text-slate-900">2&ndash;3x more enquiries</strong> than
          ...
          <div className="mt-12 border border-slate-200 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services/business-website" className="text-slate-500 hover:text-slate-900 transition-colors">
