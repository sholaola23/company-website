      ...
      <article className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">3&ndash;5 hours saved weekly</strong>{" "}
                on scheduling alone
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">1&ndash;2 hours saved</strong>{" "}
                per new client on onboarding
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">4&ndash;6 hours saved weekly</strong>{" "}
                on content creation
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">7&ndash;10 days faster</strong>{" "}
                payment collection
              </li>
            </ul>
