      ...
      <article className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">3&ndash;5 hours saved weekly</strong>{" "}
                on scheduling alone
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">1&ndash;2 hours saved</strong>{" "}
                per new client on onboarding
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">4&ndash;6 hours saved weekly</strong>{" "}
                on content creation
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">7&ndash;10 days faster</strong>{" "}
                payment collection
              </li>
            </ul>
