        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Problem:</strong> You give a
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Problem:</strong> Emergency
            ...
            <p className="text-slate-500 leading-relaxed mb-4">
              <strong className="text-slate-900">Solution:</strong> AI
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Problem:</strong> You finish a
            ...
            <p className="text-slate-500 leading-relaxed mb-4">
              <strong className="text-slate-900">Solution:</strong> The moment
