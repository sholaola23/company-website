        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-300 leading-relaxed mb-4">
              ...
              <strong className="text-zinc-100">15&ndash;20 hours per week</strong>{" "}
            ...
            <p className="text-zinc-300 leading-relaxed mb-4">
              ...
              <strong className="text-zinc-100">&pound;15&ndash;25/hour</strong>{" "}
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-6 mb-8">
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">15 hours/week &times; &pound;15/hour</strong>{" "}
                = &pound;225/week = <strong className="text-zinc-100">&pound;975/month</strong>
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">20 hours/week &times; &pound;20/hour</strong>{" "}
                = &pound;400/week = <strong className="text-zinc-100">&pound;1,733/month</strong>
              </p>
              <p className="text-zinc-300 leading-relaxed">
                <strong className="text-zinc-100">20 hours/week &times; &pound;25/hour</strong>{" "}
                = &pound;500/week = <strong className="text-zinc-100">&pound;2,166/month</strong>
              </p>
            </div>
            ...
            {/* Scenario 1 */}
            <h3 className="text-xl font-semibold mt-8 mb-3 text-zinc-100">
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-6 mb-4">
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Setup cost:</strong> &pound;500 (one-time)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Monthly running cost:</strong> &pound;50 (retainer + platform)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Quotes sent per month:</strong> 60
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Previous conversion rate:</strong> 30% (18 jobs)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">New conversion rate (with follow-up):</strong> 37% (22 jobs)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Extra jobs per month:</strong> 4
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Average job value:</strong> &pound;350
              </p>
              <p className="text-zinc-300 leading-relaxed mb-4">
                <strong className="text-zinc-100">Extra revenue per month:</strong> &pound;1,400
              </p>
              <hr className="border-zinc-700 my-3" />
              <p className="text-zinc-300 leading-relaxed mb-1">
                <strong className="text-zinc-100">Monthly ROI:</strong> &pound;1,400 &minus; &pound;50 = &pound;1,350 net gain
              </p>
              <p className="text-zinc-300 leading-relaxed mb-1">
                <strong className="text-zinc-100">Payback period:</strong> Setup cost recovered in first 2 weeks
              </p>
              <p className="text-zinc-300 leading-relaxed">
                <strong className="text-zinc-100">Annual ROI:</strong> &pound;16,200 net gain on a &pound;1,100 investment = 1,373% return
              </p>
            </div>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-6 mb-4">
              ...
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Appointments per month:</strong> 300
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Previous no-show rate:</strong> 12% (36 no-shows)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">New no-show rate (with reminders):</strong> 4% (12 no-shows)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Recovered appointments:</strong> 24 per month
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Average appointment value:</strong> &pound;35
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Recovered revenue:</strong> &pound;840/month
              </p>
              <p className="text-zinc-300 leading-relaxed mb-4">
                <strong className="text-zinc-100">Admin time saved:</strong> 8 hours/week on phone bookings = &pound;480/month (at &pound;15/hr)
              </p>
              <hr className="border-zinc-700 my-3" />
              <p className="text-zinc-300 leading-relaxed mb-1">
                <strong className="text-zinc-100">Total monthly benefit:</strong> &pound;840 + &pound;480 = &pound;1,320
              </p>
              <p className="text-zinc-300 leading-relaxed mb-1">
                <strong className="text-zinc-100">Monthly ROI:</strong> &pound;1,320 &minus; &pound;50 = &pound;1,270 net gain
              </p>
              <p className="text-zinc-300 leading-relaxed">
                <strong className="text-zinc-100">Payback period:</strong> Under 3 weeks
              </p>
            </div>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-6 mb-4">
              ...
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Previous Google reviews:</strong> 45 (3.8 star average)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">After 3 months:</strong> 120 reviews (4.5 star average)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Google Maps ranking improvement:</strong> From position 8 to position 2
              </p>
              <p className="text-zinc-300 leading-relaxed mb-2">
                <strong className="text-zinc-100">Estimated extra covers per week:</strong> 15&ndash;20 (from improved visibility)
              </p>
              <p className="text-zinc-300 leading-relaxed mb-4">
                <strong className="text-zinc-100">Average spend per cover:</strong> &pound;22
              </p>
              <hr className="border-zinc-700 my-3" />
              <p className="text-zinc-300 leading-relaxed mb-1">
                <strong className="text-zinc-100">Extra weekly revenue:</strong> 15 &times; &pound;22 = &pound;330
              </p>
              <p className="text-zinc-300 leading-relaxed mb-1">
                <strong className="text-zinc-100">Extra monthly revenue:</strong> &pound;1,430
              </p>
              <p className="text-zinc-300 leading-relaxed">
                <strong className="text-zinc-100">Monthly ROI:</strong> &pound;1,430 &minus; &pound;50 = &pound;1,380 net gain (after ramp-up period)
              </p>
            </div>
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-6 mb-6">
              <p className="text-zinc-300 leading-relaxed">
                <strong className="text-zinc-100">Your admin hours/week</strong>{" "}
                &times;{" "}
                <strong className="text-zinc-100">&pound;[hourly rate]</strong>{" "}
                &times;{" "}
                <strong className="text-zinc-100">4.3 weeks</strong>{" "}
                ={" "}
                <strong className="text-zinc-100">Monthly admin cost</strong>
              </p>
            </div>
            ...
            <ul className="text-zinc-300 leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-zinc-100">Slow lead response:</strong>{" "}
                How many enquiries per week go unanswered for more than an
                hour? Each one is a potential lost customer.
              </li>
              <li>
                <strong className="text-zinc-100">No follow-up:</strong>{" "}
            ...
            <div className="bg-zinc-800/50 border border-zinc-700 rounded-lg p-6 mb-6">
              <p className="text-zinc-300 leading-relaxed">
                <strong className="text-zinc-100">Lost leads/week</strong>{" "}
                &times;{" "}
                <strong className="text-zinc-100">average job value</strong>{" "}
                &times;{" "}
                <strong className="text-zinc-100">0.3 (recovery rate)</strong>{" "}
                &times;{" "}
                <strong className="text-zinc-100">4.3 weeks</strong>{" "}
                ={" "}
                <strong className="text-zinc-100">Monthly recovered revenue</strong>
              </p>
            </div>
            ...
            <ul className="text-zinc-300 leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-zinc-100">&pound;500 setup</strong>{" "}
                for a starter package (1&ndash;2 automations)
              </li>
              <li>
                <strong className="text-zinc-100">&pound;50&ndash;150/month</strong>{" "}
            ...
            <ul className="text-zinc-300 leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-zinc-100">You have fewer than 5 leads per week.</strong>{" "}
                Automation shines with volume. If you&apos;re getting 2&ndash;3
                enquiries a week, you can probably handle them manually.
              </li>
              <li>
                <strong className="text-zinc-100">Your processes aren&apos;t defined yet.</strong>{" "}
                You can&apos;t automate chaos. If you don&apos;t have a clear
                sales process or booking flow, sort that out first.
              </li>
              <li>
                <strong className="text-zinc-100">You&apos;re not willing to invest 30 minutes in setup.</strong>{" "}
            ...
            <ul className="text-zinc-300 leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-zinc-100">5&ndash;15 hours/week</strong>{" "}
                saved on admin and manual tasks
              </li>
              <li>
                <strong className="text-zinc-100">&pound;800&ndash;2,000/month</strong>{" "}
                in recovered revenue or time savings
              </li>
              <li>
                <strong className="text-zinc-100">2&ndash;4 week</strong>{" "}
                payback on setup costs
              </li>
              <li>
                <strong className="text-zinc-100">10&ndash;25x annual ROI</strong>{" "}
                on total investment
              </li>
            </ul>
