        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-8">
              ...
              you <strong className="text-[var(--color-heading)]">21 times more likely</strong>{" "}
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Quoting:</strong>{" "}
                Save 3 hours/week on manual quote preparation and sending
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Scheduling:</strong>{" "}
                Save 3 hours/week on staff coordination and diary management
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Follow-ups:</strong>{" "}
                Save 2 hours/week chasing leads who did not reply
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Invoice chasing:</strong>{" "}
          ...
          <div className="mt-12 border border-[var(--color-border)] rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/cleaning-business-automate-first" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
                  AI for Cleaning Businesses: 3 Tasks to Automate First
                </Link>
              </li>
              <li>
                <Link href="/blog/automate-customer-follow-ups" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
