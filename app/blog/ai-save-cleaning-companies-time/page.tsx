        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-300 leading-relaxed mb-8">
              ...
              you <strong className="text-zinc-100">21 times more likely</strong>{" "}
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Quoting:</strong>{" "}
                Save 3 hours/week on manual quote preparation and sending
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Scheduling:</strong>{" "}
                Save 3 hours/week on staff coordination and diary management
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Follow-ups:</strong>{" "}
                Save 2 hours/week chasing leads who did not reply
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Invoice chasing:</strong>{" "}
          ...
          <div className="mt-12 border border-zinc-800 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/cleaning-business-automate-first" className="text-blue-400 hover:text-blue-300 transition-colors">
                  AI for Cleaning Businesses: 3 Tasks to Automate First
                </Link>
              </li>
              <li>
                <Link href="/blog/automate-customer-follow-ups" className="text-blue-400 hover:text-blue-300 transition-colors">
