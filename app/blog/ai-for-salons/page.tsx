        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">No-show reduction:</strong>{" "}
                Save 3 appointments per week = <strong className="text-slate-900">&pound;135/week</strong>
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">Rebooking increase:</strong>{" "}
                5 extra rebookings per week = <strong className="text-slate-900">&pound;225/week</strong>
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">Waitlist fills:</strong>{" "}
                2 filled cancellations per week = <strong className="text-slate-900">&pound;90/week</strong>
              </li>
            </ul>

            <p className="text-slate-500 leading-relaxed mb-4">
              That&apos;s &pound;450 extra per week, or over{" "}
              <strong className="text-slate-900">&pound;23,000 a year</strong>.
          ...
          <div className="mt-12 border border-slate-200 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/blog/ai-for-gyms" className="text-blue-600 hover:text-blue-600 transition-colors">
