        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">No-show reduction:</strong>{" "}
                Save 3 appointments per week = <strong className="text-[var(--color-heading)]">&pound;135/week</strong>
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Rebooking increase:</strong>{" "}
                5 extra rebookings per week = <strong className="text-[var(--color-heading)]">&pound;225/week</strong>
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Waitlist fills:</strong>{" "}
                2 filled cancellations per week = <strong className="text-[var(--color-heading)]">&pound;90/week</strong>
              </li>
            </ul>

            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              That&apos;s &pound;450 extra per week, or over{" "}
              <strong className="text-[var(--color-heading)]">&pound;23,000 a year</strong>.
          ...
          <div className="mt-12 border border-[var(--color-border)] rounded-xl p-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/blog/ai-for-gyms" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
