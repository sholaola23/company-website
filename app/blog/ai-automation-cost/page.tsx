        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
              ...
              <table className="w-full text-sm">
                ...
                <tbody className="text-[var(--color-muted)]">
                  ...
                  <tr className="border-b border-[var(--color-border)]/50 bg-[var(--color-primary)]/5">
                    ...
                    <td className="py-3 px-4 text-[var(--color-heading)]">7 days</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">plumber</strong> recovered
                &pound;1,400/month in lost quotes with automated follow-ups
                (&pound;500 setup)
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">salon</strong> reduced
              ...
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">restaurant</strong> saved
          ...
          <div className="mt-12 border border-[var(--color-border)] rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/n8n-vs-zapier-vs-make" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
