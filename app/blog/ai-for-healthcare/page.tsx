        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">45% fewer phone calls</strong>{" "}
                to reception
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">40&ndash;60% fewer no-shows</strong>{" "}
                with automated reminders
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">7&ndash;10 hours saved daily</strong>{" "}
                on form processing
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                <strong className="text-slate-900">25% increase in follow-up bookings</strong>{" "}
          ...
          <div className="mt-12 border border-slate-200 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services/voice-assistant" className="text-slate-500 hover:text-slate-900 transition-colors">
