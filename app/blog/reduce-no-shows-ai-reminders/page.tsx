        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">24 hours before:</strong>{" "}
                A friendly reminder with the appointment details and a link to
                confirm or reschedule
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">2 hours before:</strong>{" "}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <div className="bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-lg p-5 text-center">
                ...
                <p className="text-[var(--color-body)] text-sm">no-shows per week (before)</p>
              </div>
              <div className="bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-lg p-5 text-center">
                <p className="text-3xl font-bold text-[var(--color-primary)] mb-1">6</p>
                <p className="text-[var(--color-body)] text-sm">no-shows per week (after)</p>
              </div>
              <div className="bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-lg p-5 text-center">
                <p className="text-3xl font-bold text-[var(--color-primary)] mb-1">9</p>
                <p className="text-[var(--color-body)] text-sm">recovered appointments per week</p>
              </div>
              <div className="bg-[var(--color-bg-alt)] border border-[var(--color-border)] rounded-lg p-5 text-center">
                <p className="text-3xl font-bold text-[var(--color-primary)] mb-1">&pound;23k+</p>
                <p className="text-[var(--color-body)] text-sm">recovered revenue per year (at &pound;50/appt)</p>
              </div>
            </div>
          ...
          <div className="mt-12 border border-[var(--color-border)] rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/voice-ai-small-business" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
