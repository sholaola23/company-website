          ...
          <div className="prose prose-invert max-w-none">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 mb-8">
              <div className="space-y-3">
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">Vercel Pro (website + dashboards + APIs)</span>
                  <span className="text-zinc-100 font-semibold">&pound;16/mo</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">Claude API (agent fleet + chat widget + reports)</span>
                  <span className="text-zinc-100 font-semibold">&pound;50&ndash;100/mo</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">Zapier (simple client-facing flows)</span>
                  <span className="text-zinc-100 font-semibold">&pound;25/mo</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">n8n Cloud (workflow automation)</span>
                  <span className="text-zinc-100 font-semibold">Free tier</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">Resend (transactional email)</span>
                  <span className="text-zinc-100 font-semibold">Free tier</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">Make.com (mid-complexity workflows)</span>
                  <span className="text-zinc-100 font-semibold">Free tier</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">Beehiiv (newsletter)</span>
                  <span className="text-zinc-100 font-semibold">Existing plan</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-zinc-800">
                  <span className="text-zinc-300">Domains + ScrapeCreators</span>
                  <span className="text-zinc-100 font-semibold">~&pound;10/mo</span>
                </div>
                <div className="flex justify-between items-center py-3 mt-2 bg-zinc-800/50 rounded-lg px-4">
                  <span className="text-zinc-100 font-bold">Total</span>
                  <span className="text-blue-400 font-bold text-lg">&pound;100&ndash;150/mo</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5 text-center">
                <p className="text-3xl font-bold text-blue-400 mb-1">63</p>
                <p className="text-zinc-400 text-sm">AI agents running daily</p>
              </div>
              <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5 text-center">
                <p className="text-3xl font-bold text-blue-400 mb-1">2</p>
                <p className="text-zinc-400 text-sm">live client dashboards</p>
              </div>
              <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5 text-center">
                <p className="text-3xl font-bold text-blue-400 mb-1">50+</p>
                <p className="text-zinc-400 text-sm">emails sent daily on autopilot</p>
              </div>
              <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-5 text-center">
                <p className="text-3xl font-bold text-blue-400 mb-1">24/7</p>
                <p className="text-zinc-400 text-sm">client workflow monitoring</p>
              </div>
            </div>
            ...
            <ul className="space-y-3 mb-8">
              <li className="flex gap-3 text-zinc-300">
                ...
                <span>
                  <strong className="text-zinc-100">Outreach agents</strong> research
              ...
              <li className="flex gap-3 text-zinc-300">
                <span className="text-blue-400 font-bold shrink-0">&bull;</span>
                <span>
                  <strong className="text-zinc-100">Content agents</strong> write blog
              ...
              <li className="flex gap-3 text-zinc-300">
                <span className="text-blue-400 font-bold shrink-0">&bull;</span>
                <span>
                  <strong className="text-zinc-100">QA agents</strong> review every
              ...
              <li className="flex gap-3 text-zinc-300">
                <span className="text-blue-400 font-bold shrink-0">&bull;</span>
                <span>
                  <strong className="text-zinc-100">Client monitoring agents</strong>{" "}
              ...
              <li className="flex gap-3 text-zinc-300">
                <span className="text-blue-400 font-bold shrink-0">&bull;</span>
                <span>
                  <strong className="text-zinc-100">Executive agents</strong> run
              ...
              <li className="flex gap-3 text-zinc-300">
                <span className="text-blue-400 font-bold shrink-0">&bull;</span>
                <span>
                  <strong className="text-zinc-100">A 24/7 AI chat widget</strong>{" "}
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-6 mb-6 space-y-4">
              ...
              <div>
                <p className="text-zinc-300">
                  <strong className="text-zinc-100">Gross margin:</strong>{" "}
                  90%+ on the retainer
                </p>
              </div>
            </div>
