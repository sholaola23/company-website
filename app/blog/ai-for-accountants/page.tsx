        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Problem:</strong> Every new
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Problem:</strong> You&apos;re
            ...
            <p className="text-zinc-300 leading-relaxed mb-2">
              <strong className="text-zinc-100">Problem:</strong> Every week,
            ...
            <p className="text-zinc-300 leading-relaxed mb-4">
              <strong className="text-zinc-100">Solution:</strong> A branded
            ...
            <p className="text-zinc-300 leading-relaxed mb-4">
              <strong className="text-zinc-100">Result:</strong> A practice
          ...
          <div className="mt-12 border border-zinc-800 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="/blog/ai-for-coaches" className="text-blue-400 hover:text-blue-300 transition-colors">
              ...
              <li>
                <Link href="/services/email-assistant" className="text-zinc-300 hover:text-white transition-colors">
