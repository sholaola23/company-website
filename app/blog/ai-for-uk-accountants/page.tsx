...
const articleJsonLd = {
  ...
  mainEntityOfPage:
    "https://workcrew.io/blog/ai-for-uk-accountants",
};
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Client onboarding:</strong>{" "}
                Save 4 hours/month on form chasing and data entry
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Document collection:</strong>{" "}
              ...
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Deadline management:</strong>{" "}
          ...
          <div className="mt-12 border border-[var(--color-border)] rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/ai-accountants-save-20-hours" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
                  AI for UK Accountants: Reclaiming 20+ Hours a Month
                </Link>
              </li>
              <li>
                <Link href="/blog/ai-for-solicitors" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
