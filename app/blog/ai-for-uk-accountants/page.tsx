        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Client onboarding:</strong>{" "}
                Save 4 hours/month on form chasing and data entry
              </li>
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Document collection:</strong>{" "}
              ...
              <li className="text-zinc-300 ml-6 list-disc">
                <strong className="text-zinc-100">Deadline management:</strong>{" "}
          ...
          <div className="mt-12 border border-zinc-800 rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/ai-accountants-save-20-hours" className="text-blue-400 hover:text-blue-300 transition-colors">
                  AI for UK Accountants: Reclaiming 20+ Hours a Month
                </Link>
              </li>
              <li>
                <Link href="/blog/ai-for-solicitors" className="text-blue-400 hover:text-blue-300 transition-colors">
