          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Step 1:</strong> Fill in a
                short form about your business &mdash; what you do, how many
                customers you have, what tools you currently use
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Step 2:</strong> We review
                your answers and research your business (we&apos;ll look at
                your website, Google profile, and online presence)
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Step 3:</strong> We send
                you a personalised audit report within 48 hours
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Step 4:</strong> Optionally,
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Do nothing</strong> &mdash;
                keep the report as a reference. No hard feelings.
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">DIY it</strong> &mdash; use
                our recommendations to set things up yourself or with another
                provider. The report gives you enough detail to brief anyone.
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Work with us</strong> &mdash;
