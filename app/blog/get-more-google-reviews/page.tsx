        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">93% of consumers</strong>{" "}
                read online reviews before choosing a local business
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                Businesses in the Google <strong className="text-[var(--color-heading)]">top 3 local results</strong>{" "}
                have an average of 47 reviews
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">one-star increase</strong>{" "}
                on Google can boost revenue by 5&ndash;9%
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">72% of customers</strong>{" "}
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">You forget to ask</strong>{" "}
                &mdash; you finish a job, move on to the next one, and
                asking for a review slips your mind
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">It feels awkward</strong>{" "}
                &mdash; asking face-to-face for a review can feel pushy,
                especially for trades and service businesses
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                <strong className="text-[var(--color-heading)]">Customers mean to but don&apos;t</strong>{" "}
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">plumbing company</strong>{" "}
                went from 12 reviews to 47 in 3 months
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">salon</strong> went from
                23 reviews to 89 in 4 months
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">dental practice</strong>{" "}
                went from 31 reviews to 112 in 6 months
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                A <strong className="text-[var(--color-heading)]">cleaning company</strong>{" "}
          ...
          <div className="mt-12 border border-[var(--color-border)] rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/blog/local-business-website-2026" className="text-[var(--color-primary)] hover:text-[var(--color-primary)] transition-colors">
              ...
              <li>
                <Link href="/services/seo-content" className="text-[var(--color-muted)] hover:text-[var(--color-heading)] transition-colors">
