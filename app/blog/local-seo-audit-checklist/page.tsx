...
function TaskItem({
  ...
  return (
    <div className="flex gap-4 mb-6">
      <span className="shrink-0 flex items-center justify-center w-8 h-8 rounded-full bg-blue-500/20 text-blue-400 text-sm font-bold border border-blue-500/30">
        {number}
      </span>
      <div>
        <p className="text-zinc-100 font-semibold mb-1">{title}</p>
      ...
      <article className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-zinc-300 leading-relaxed mb-8">
              We are calling it <strong className="text-zinc-100">RankReady</strong>.
            ...
            {/* Secondary CTA */}
            <p className="text-zinc-300 leading-relaxed mt-8 mb-4">
