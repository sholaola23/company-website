        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <div className="overflow-x-auto mb-8">
              <table className="w-full text-sm text-[var(--color-muted)] border border-[var(--color-border)]">
                <thead>
                  <tr className="bg-[var(--color-surface)]/50">
                    <th className="text-left p-3 border-b border-[var(--color-border)] font-semibold text-[var(--color-heading)]">Feature</th>
                    <th className="text-left p-3 border-b border-[var(--color-border)] font-semibold text-[var(--color-heading)]">Zapier</th>
                    <th className="text-left p-3 border-b border-[var(--color-border)] font-semibold text-[var(--color-heading)]">Make</th>
                    <th className="text-left p-3 border-b border-[var(--color-border)] font-semibold text-[var(--color-heading)]">n8n</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">Starting Price</td>
                    <td className="p-3 border-b border-[var(--color-border)]">From $20/month</td>
                    <td className="p-3 border-b border-[var(--color-border)]">From $9/month</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Free (self-hosted) or $20/month (cloud)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">Free Tier</td>
                    <td className="p-3 border-b border-[var(--color-border)]">100 tasks/month</td>
                    <td className="p-3 border-b border-[var(--color-border)]">1,000 ops/month</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Unlimited (self-hosted)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">Ease of Use</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Easiest</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Moderate</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Moderate&ndash;Advanced</td>
                  </tr>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">App Integrations</td>
                    <td className="p-3 border-b border-[var(--color-border)]">7,000+</td>
                    <td className="p-3 border-b border-[var(--color-border)]">1,800+</td>
                    <td className="p-3 border-b border-[var(--color-border)]">400+ (plus custom nodes)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">Self-Hosting</td>
                    <td className="p-3 border-b border-[var(--color-border)]">No</td>
                    <td className="p-3 border-b border-[var(--color-border)]">No</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Yes</td>
                  </tr>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">Data Stays in UK/EU</td>
                    <td className="p-3 border-b border-[var(--color-border)]">No (US servers)</td>
                    <td className="p-3 border-b border-[var(--color-border)]">EU option available</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Yes (if self-hosted on UK server)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">AI Capabilities</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Basic (AI actions)</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Good (AI modules)</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Excellent (full AI agent support)</td>
                  </tr>
                  <tr>
                    <td className="p-3 border-b border-[var(--color-border)] font-medium text-[var(--color-heading)]">Best For</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Simple automations</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Mid-complexity, visual workflows</td>
                    <td className="p-3 border-b border-[var(--color-border)]">Complex automations, AI workflows, full control</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <ul className="text-[var(--color-muted)] leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-[var(--color-heading)]">Dead simple to learn.</strong>{" "}
                You can set up a basic automation in 10 minutes with no
                technical knowledge.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Massive app library.</strong>{" "}
                If it exists, Zapier probably connects to it.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Good for quick wins.</strong>{" "}
                &ldquo;When I get a new form submission, add it to my
                spreadsheet and send me an email&rdquo; &mdash; done in 5
                minutes.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Client self-service.</strong>{" "}
            ...
            <ul className="text-[var(--color-muted)] leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-[var(--color-heading)]">Expensive at scale.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">Limited complexity.</strong>{" "}
                Branching logic, loops, and error handling are clunky compared
                to Make and n8n.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">US-hosted data.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">Weak AI support.</strong>{" "}
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-8">
              <strong className="text-[var(--color-heading)]">Best for:</strong> Business
            ...
            <ul className="text-[var(--color-muted)] leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-[var(--color-heading)]">Visual workflow builder.</strong>{" "}
                You can see the entire flow at a glance. This makes debugging
                much easier than Zapier&apos;s linear view.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Better pricing.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">EU data hosting.</strong>{" "}
                Make offers EU-hosted instances, which is better for GDPR
                compliance than Zapier&apos;s US-only setup.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Good branching and error handling.</strong>{" "}
                Routers, filters, and error routes are built in and easy to use.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Solid AI modules.</strong>{" "}
            ...
            <ul className="text-[var(--color-muted)] leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-[var(--color-heading)]">Steeper learning curve than Zapier.</strong>{" "}
                It&apos;s not hard, but it takes longer to get comfortable with
                the visual builder.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">No self-hosting.</strong>{" "}
                Your data still lives on Make&apos;s servers. You can&apos;t
                run it on your own infrastructure.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Fewer native integrations.</strong>{" "}
                1,800 apps versus Zapier&apos;s 7,000. Most popular tools are
                covered, but niche apps might need custom API connections.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Can get complex quickly.</strong>{" "}
            ...
            <ul className="text-[var(--color-muted)] leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-[var(--color-heading)]">Self-hosting option.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">No per-task pricing.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">Best AI integration.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">Full code access.</strong>{" "}
                When you need custom logic, you can write JavaScript or Python
                directly in the workflow. This makes n8n capable of handling
                almost anything.
              </li>
              <li>
                <strong className="text-[var(--color-heading)]">Community and templates.</strong>{" "}
            ...
            <ul className="text-[var(--color-muted)] leading-relaxed mb-4 list-disc pl-6 space-y-2">
              <li>
                <strong className="text-[var(--color-heading)]">Not beginner-friendly.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">Self-hosting requires maintenance.</strong>{" "}
              ...
              <li>
                <strong className="text-[var(--color-heading)]">Overkill for simple tasks.</strong>{" "}
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Choose Zapier if:</strong> You
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Choose Make if:</strong> You
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">Choose n8n if:</strong> You
          ...
          <div className="mt-12 border border-[var(--color-border)] rounded-xl p-6">
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/services/custom-build" className="text-[var(--color-muted)] hover:text-[var(--color-heading)] transition-colors">
