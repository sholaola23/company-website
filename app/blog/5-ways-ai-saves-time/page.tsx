        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Time saved:</strong> 3&ndash;5
              hours per week
            </p>
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Best for:</strong> Salons,
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Time saved:</strong> 2&ndash;3
              hours per week
            </p>
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Best for:</strong> Any service
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Time saved:</strong> 1&ndash;2
              hours per week (plus recovered revenue)
            </p>
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Best for:</strong> Any business
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Best for:</strong> Tradespeople,
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Time saved:</strong> 3&ndash;4
              hours per week
            </p>
            <p className="text-[var(--color-muted)] leading-relaxed mb-2">
              <strong className="text-[var(--color-heading)]">Best for:</strong> Restaurants,
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                Appointment booking: <strong className="text-[var(--color-heading)]">4 hours saved</strong>
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                Email responses: <strong className="text-[var(--color-heading)]">2.5 hours saved</strong>
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                Follow-up sequences: <strong className="text-[var(--color-heading)]">1.5 hours saved</strong>
              </li>
              <li className="text-[var(--color-muted)] ml-6 list-disc">
                Social media: <strong className="text-[var(--color-heading)]">3.5 hours saved</strong>
              </li>
            </ul>

            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              That&apos;s <strong className="text-[var(--color-heading)]">11.5 hours a week</strong>.
