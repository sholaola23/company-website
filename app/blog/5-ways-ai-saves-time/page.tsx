        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Time saved:</strong> 3&ndash;5
              hours per week
            </p>
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Best for:</strong> Salons,
            ...
            <p className="text-slate-500 leading-relaxed mb-8">
              ...
              <Link
                ...
                className="text-blue-600 hover:text-blue-600 underline transition-colors"
              >
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Time saved:</strong> 2&ndash;3
              hours per week
            </p>
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Best for:</strong> Any service
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Time saved:</strong> 1&ndash;2
              hours per week (plus recovered revenue)
            </p>
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Best for:</strong> Any business
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Best for:</strong> Tradespeople,
            ...
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Time saved:</strong> 3&ndash;4
              hours per week
            </p>
            <p className="text-slate-500 leading-relaxed mb-2">
              <strong className="text-slate-900">Best for:</strong> Restaurants,
            ...
            <ul className="mb-6 space-y-2">
              <li className="text-slate-500 ml-6 list-disc">
                Appointment booking: <strong className="text-slate-900">4 hours saved</strong>
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                Email responses: <strong className="text-slate-900">2.5 hours saved</strong>
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                Follow-up sequences: <strong className="text-slate-900">1.5 hours saved</strong>
              </li>
              <li className="text-slate-500 ml-6 list-disc">
                Social media: <strong className="text-slate-900">3.5 hours saved</strong>
              </li>
            </ul>

            <p className="text-slate-500 leading-relaxed mb-4">
              That&apos;s <strong className="text-slate-900">11.5 hours a week</strong>.
