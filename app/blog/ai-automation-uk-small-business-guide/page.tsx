      ...
      <article className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">What it does:</strong> When
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">Why it matters:</strong> Research
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-8">
              <strong className="text-[var(--color-heading)]">Typical result:</strong>{" "}
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">What it does:</strong> Instead of
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">Why it matters:</strong> Every
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">Why it matters:</strong> Most
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">What it does:</strong> After
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">Why it matters:</strong> Google
            ...
            <p className="text-[var(--color-muted)] leading-relaxed mb-4">
              <strong className="text-[var(--color-heading)]">What it does:</strong> AI handles
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-8">
              <Link
                ...
                className="flex items-center gap-2 bg-[var(--color-surface)]/50 hover:bg-[var(--color-surface)] border border-[var(--color-border)]/50 rounded-lg px-4 py-3 text-[var(--color-muted)] hover:text-[var(--color-heading)] transition-colors"
              >
                <ArrowRight className="w-4 h-4 text-[var(--color-primary)] flex-shrink-0" />
                AI for Plumbers
              </Link>
              <Link
