  ...
  if (authed === null) {
    return (
      <div className="min-h-screen bg-zinc-950 flex items-center justify-center">
        <div className="w-5 h-5 border-2 border-zinc-800 border-t-purple-400 rounded-full animate-spin" />
      </div>
    );
  }
...
function GorgContent() {
  return (
    <div className="min-h-screen bg-zinc-950 text-zinc-50">
          ...
          <div className="grid gap-4">
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-zinc-50">AI Booking Assistant</h3>
              ...
              <div className="bg-zinc-950 border border-zinc-800 rounded-xl p-4">
                <p className="text-xs text-zinc-600 mb-3 font-medium">Example conversation — Sunday 8pm</p>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-zinc-50">Automated Review Collection</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="bg-zinc-800/60 rounded-xl p-3 text-center">
                  <p className="text-xs text-zinc-600 mb-1">Current pace</p>
                  <p className="text-lg font-bold text-zinc-400">~2.4/mo</p>
                </div>
                <div className="bg-zinc-800/60 rounded-xl p-3 text-center">
                  <p className="text-xs text-zinc-600 mb-1">Target pace</p>
            ...
            <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  <h3 className="text-lg font-semibold text-zinc-50">Post-Treatment Follow-Up</h3>
              ...
              <div className="space-y-2">
                {[
                  ...
                  <div key={time} className="flex items-start gap-3 px-3 py-2 bg-zinc-800/40 rounded-lg">
        ...
        <div className="grid gap-4">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <h3 className="text-base font-semibold text-zinc-50">Missed inquiry recovery</h3>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
              <div className="bg-zinc-800/60 rounded-xl p-3 text-center">
                <p className="text-xs text-zinc-600 mb-1">Missed inquiries (Sun+Mon)</p>
                <p className="text-lg font-bold text-red-400">2–4/week</p>
              </div>
              <div className="bg-zinc-800/60 rounded-xl p-3 text-center">
                <p className="text-xs text-zinc-600 mb-1">Avg treatment value</p>
                <p className="text-lg font-bold text-zinc-200">$400</p>
              </div>
              <div className="bg-zinc-800/60 rounded-xl p-3 text-center">
                <p className="text-xs text-zinc-600 mb-1">Recovered per year</p>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <div className="flex items-start gap-3 mb-4">
              ...
              <h3 className="text-base font-semibold text-zinc-50">Review automation ROI</h3>
            </div>
          ...
          <div className="flex items-start gap-3 bg-purple-500/8 border border-purple-500/15 rounded-xl px-4 py-3">
            ...
            <p className="text-sm text-zinc-400">
              <strong className="text-zinc-200">Total cost: $2,000 setup + $300/month.</strong>{" "}
          ...
          <div className="bg-zinc-900 border border-purple-500/30 rounded-2xl overflow-hidden">
            ...
            <div className="p-6 md:p-8 border-b border-zinc-800">
              <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                <div>
                  <p className="text-sm text-zinc-500 mb-1">One-time setup</p>
                ...
                <div className="sm:text-right">
                  ...
                  <div className="flex items-baseline gap-2 sm:justify-end">
                    <span className="text-4xl font-bold text-purple-400">$300</span>
            ...
            <div className="px-6 pb-6 md:px-8 md:pb-8">
              <div className="flex items-start gap-3 bg-purple-500/8 border border-purple-500/15 rounded-xl px-4 py-3">
                ...
                <p className="text-sm text-zinc-400">
                  ...
                  <span className="text-zinc-200 font-medium">two to four months</span>. This
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6 md:p-8">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-full bg-purple-500/15 border border-purple-500/20 flex items-center justify-center">
              <span className="text-sm font-bold text-purple-400">E</span>
            </div>
            <div>
              <p className="text-sm font-semibold text-zinc-200">E&apos;Manuel Bakery</p>
              <p className="text-xs text-zinc-500">Local service business, owner-operated, 6 employees</p>
            </div>
          </div>
      ...
      <Section
        id="cta"
        className="px-5 py-16 md:py-20 bg-zinc-900/40 border-y border-zinc-800/50"
      >
