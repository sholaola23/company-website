      ...
      <div className="space-y-6 mb-8">
        ...
        <div>
          <div className="flex justify-between items-baseline mb-2">
            <label className="text-sm text-zinc-400">Missed calls per week</label>
        ...
        <div>
          <div className="flex justify-between items-baseline mb-2">
            <label className="text-sm text-zinc-400">Average job value</label>
            <span className="text-2xl font-bold text-amber-400">${jobValue.toLocaleString()}</span>
          </div>
          <input
            type="range"
            min={200}
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="bg-zinc-950 border border-zinc-800 rounded-2xl overflow-hidden mb-8">
            ...
            <div className="flex items-center gap-3 px-4 py-3 border-b border-zinc-800 bg-zinc-900">
              ...
              <div>
                <p className="text-sm font-semibold text-zinc-50">Incoming call — (615) 394-6000</p>
                <div className="flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-green-500" />
                  <p className="text-xs text-zinc-500">Sunday 9:14pm — call answered in 2 rings</p>
                </div>
              </div>
            </div>
          ...
          <div className="grid gap-3">
            ...
            <div className="flex items-start gap-3 p-4 bg-zinc-900 border border-zinc-800 rounded-xl">
              ...
              <div>
                <p className="text-sm font-semibold text-zinc-200 mb-0.5">SMS to Jeff&apos;s phone</p>
            ...
            <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
              <div>
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-bold text-zinc-50">$1,500</span>
                </div>
          ...
          <div className="px-6 pb-6 md:px-8 md:pb-8">
            <div className="flex items-start gap-3 bg-amber-500/8 border border-amber-500/15 rounded-xl px-4 py-3">
              ...
              <p className="text-sm text-zinc-400">
                ...
                <span className="text-zinc-200 font-medium">$800 minimum</span>.
                This phone system costs{" "}
                <span className="text-zinc-200 font-medium">$200/month</span>. It
      ...
      >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 mb-10">
          <Link
            ...
            className="inline-flex items-center gap-2 px-6 py-3.5 bg-amber-500 hover:bg-amber-400 text-zinc-950 font-semibold rounded-xl transition-all text-sm w-full sm:w-auto justify-center"
          >
