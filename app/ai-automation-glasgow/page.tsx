...
const CITY = "Glasgow";
const SLUG = "ai-automation-glasgow";
...
const SERVICES = [
  {
    ...
    description:
      "Capture leads from your website, qualify them automatically, and book appointments into your calendar — without lifting a finger. Perfect for Glasgow's 25,000+ SMBs, from Merchant City hospitality to trades businesses serving homes and offices across the city.",
    href: "/services/lead-intake",
  },
  {
    title: "AI Email Assistant",
    description:
      "Draft professional replies to customer emails in seconds. Your inbox stays under control even during Glasgow's busiest periods — from event season to the constant demand for trades and services across Scotland's largest city.",
    href: "/services/email-assistant",
  },
  {
    title: "SEO Content Automation",
    description:
      "Publish locally optimised blog posts and landing pages on autopilot. Rank higher in local search results and attract more Glasgow and central Scotland customers to your business.",
...
export default function AIAutomationGlasgowPage() {
  return (
      ...
      <AnimatedSection>
        <div className="max-w-3xl mx-auto text-center mb-16 sm:mb-20">
          ...
          <p className="text-lg text-zinc-400 leading-relaxed">
            Glasgow is Scotland&apos;s largest city and one of the fastest
            growing tech hubs outside London, with over 25,000 small businesses
            powering its economy — from its thriving hospitality scene to trades
            businesses serving homes and offices across the region. The
