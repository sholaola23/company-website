...
export default function RankReadyPage() {
            ...
            <div>
              ...
              {form.secondaryServices.map((s, i) => (
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-700 bg-zinc-800/80 px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none mb-2"
                />
              ))}
            </div>
            <div>
            ...
            {form.competitors.map((comp, i) => (
              <div key={i} className="space-y-2">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-zinc-700 bg-zinc-800/80 px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none"
                />
                <input
                  type="url"
                  value={comp.url}
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full rounded-lg border border-zinc-700 bg-zinc-800/80 px-4 py-2.5 text-sm text-zinc-100 placeholder-zinc-500 focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none resize-none"
              />
            </div>
            <Field
              label="Email Address *"
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
      ...
      {/* Cancelled banner */}
      {cancelled && (
        <div className="max-w-2xl mx-auto mb-6 rounded-lg border border-yellow-500/30 bg-yellow-500/10 px-4 py-3 text-sm text-yellow-300 text-center">
          ...
          <div className="flex items-center justify-between mt-8 pt-6 border-t border-zinc-800">
            ...
            {step < STEPS.length - 1 ? (
              <button
                ...
                disabled={!canProceed()}
                className="flex items-center gap-2 rounded-lg bg-blue-600 px-6 py-2.5 text-sm font-semibold text-white hover:bg-blue-500 transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
              >
                Next
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <button
                  ...
                  disabled={!!submitting}
                  className="flex items-center justify-center gap-2 rounded-lg border border-blue-500/40 bg-blue-500/10 px-5 py-2.5 text-sm font-semibold text-blue-400 hover:bg-blue-500/20 transition-colors disabled:opacity-40"
                >
                  {submitting === "preview" ? (
