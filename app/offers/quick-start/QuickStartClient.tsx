...
function CountdownBlock({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <span className="text-2xl sm:text-3xl font-bold tabular-nums text-zinc-50">
  ...
  if (status === "success") {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-lg font-semibold text-zinc-50 mb-2">You&apos;re in!</p>
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
      ...
      <div className="text-center mb-16">
        {/* Urgency pill */}
        <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-1.5 text-xs font-medium tracking-wide text-amber-400">
          <Clock size={12} aria-hidden="true" />
          {expired ? "Offer ended" : "This week only — ends Sunday 30 March"}
        </div>

        <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-zinc-50 leading-tight mb-4">
          <span className="line-through text-zinc-500 text-2xl sm:text-3xl lg:text-4xl mr-3">
            £500
          </span>
          <span className="text-blue-400">£297</span> Quick-Start AI Package
        </h1>
      ...
      {!expired && (
        <div className="mb-16">
          <div className="flex items-center justify-center gap-4 sm:gap-6 bg-zinc-900 border border-zinc-800 rounded-2xl py-6 px-6 max-w-md mx-auto">
            <CountdownBlock value={timeLeft.days} label="Days" />
            <span className="text-zinc-600 text-xl font-light" aria-hidden="true">:</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
        ...
        <div>
            ...
            {INCLUDED.map((item) => (
              ...
              >
                <div className="flex items-center justify-center w-10 h-10 rounded-lg bg-blue-500/10 border border-blue-500/20 shrink-0">
                  <item.icon size={16} className="text-blue-400" aria-hidden="true" />
                </div>
                <div>
                  <p className="text-sm font-semibold text-zinc-50 mb-0.5">{item.title}</p>
          ...
          {/* Social proof */}
          <div className="mt-8 bg-gradient-to-br from-blue-500/10 to-zinc-900 border border-blue-500/20 rounded-xl p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-zinc-900/60 border border-zinc-800 rounded-lg p-3 text-center">
                <p className="text-xl font-bold text-zinc-50">8+</p>
                <p className="text-xs text-zinc-500 mt-0.5">Hours/week saved</p>
              </div>
              <div className="bg-zinc-900/60 border border-zinc-800 rounded-lg p-3 text-center">
                <p className="text-xl font-bold text-zinc-50">180</p>
                <p className="text-xs text-zinc-500 mt-0.5">Orders automated</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-7 sm:p-8 sticky top-24">
            ...
            <div className="mb-6 pb-6 border-b border-zinc-800">
              <div className="flex items-baseline gap-2">
                <span className="text-3xl font-bold text-zinc-50">£297</span>
            ...
            <div className="mt-6 pt-6 border-t border-zinc-800 text-center">
              <p className="text-xs text-zinc-500 mb-2">Prefer email?</p>
              <a
      ...
      {/* ── How it works ───────────────────────────────────────────────── */}
      <div className="mt-20">
        <h2 className="text-lg font-semibold text-zinc-50 text-center mb-10">
          How it works
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            ...
            >
              <div className="inline-flex items-center justify-center w-8 h-8 rounded-full bg-blue-500/10 border border-blue-500/20 text-sm font-bold text-blue-400 mb-4">
                {item.step}
              </div>
              <p className="text-sm font-semibold text-zinc-50 mb-1">{item.title}</p>
              <p className="text-sm text-zinc-400 leading-relaxed">{item.desc}</p>
            </div>
          ))}
        </div>
      ...
      <div className="mt-20 text-center">
        <div className="bg-gradient-to-br from-blue-500/10 to-zinc-900 border border-blue-500/20 rounded-2xl p-8 sm:p-12 max-w-2xl mx-auto">
